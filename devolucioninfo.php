...
//
// Table class for devolucion
//
class cdevolucion extends cTable {
	var $id;
	var $empleado;
	var $fecha;
	var $cliente;
	...
	function __construct() {
		...
		$this->TableVar = 'devolucion';
		$this->TableName = 'devolucion';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`devolucion`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('devolucion', 'devolucion', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// empleado
		$this->empleado = new cField('devolucion', 'devolucion', 'x_empleado', 'empleado', '`empleado`', '`empleado`', 200, -1, FALSE, '`empleado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['empleado'] = &$this->empleado;

		// fecha
		$this->fecha = new cField('devolucion', 'devolucion', 'x_fecha', 'fecha', '`fecha`', '`fecha`', 3, -1, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fecha->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		...
		// empresa
		$this->empresa = new cField('devolucion', 'devolucion', 'x_empresa', 'empresa', '`empresa`', '`empresa`', 3, -1, FALSE, '`empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`devolucion`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("devolucionview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("devolucionview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "devolucionadd.php?" . $this->UrlParm($parm);
		else
			$url = "devolucionadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("devolucionedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("devolucionadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("devoluciondelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->empleado->EditValue = $this->empleado->CurrentValue;
