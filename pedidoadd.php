...
class cpedido_add extends cpedido {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "pedidoview.php")
	...
	function LoadDefaultValues() {
		$this->empleado->CurrentValue = NULL;
		$this->empleado->OldValue = $this->empleado->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// empleado
		$this->empleado->SetDbValueDef($rsnew, $this->empleado->CurrentValue, "", FALSE);
