...
var CurrentForm = fclienteview = new ew_Form("fclienteview", "view");
...
<?php if ($cliente->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_cliente_id"><?php echo $cliente->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $cliente->id->CellAttributes() ?>>
<span id="el_cliente_id">
<span<?php echo $cliente->id->ViewAttributes() ?>>
<?php echo $cliente->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cliente->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_cliente_nombre"><?php echo $cliente->nombre->FldCaption() ?></span></td>
...
<?php echo $cliente->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cliente->ci->Visible) { // ci ?>
	<tr id="r_ci">
		<td><span id="elh_cliente_ci"><?php echo $cliente->ci->FldCaption() ?></span></td>
		<td data-name="ci"<?php echo $cliente->ci->CellAttributes() ?>>
