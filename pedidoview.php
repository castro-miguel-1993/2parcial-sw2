...
<?php if ($pedido->empresa->Visible) { // empresa ?>
	<tr id="r_empresa">
		<td><span id="elh_pedido_empresa"><?php echo $pedido->empresa->FldCaption() ?></span></td>
		<td data-name="empresa"<?php echo $pedido->empresa->CellAttributes() ?>>
<span id="el_pedido_empresa">
<span<?php echo $pedido->empresa->ViewAttributes() ?>>
<?php echo $pedido->empresa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
