...
class cpedido extends cTable {
	...
	function __construct() {
		...
		// empleado
		$this->empleado = new cField('pedido', 'pedido', 'x_empleado', 'empleado', '`empleado`', '`empleado`', 200, -1, FALSE, '`empleado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['empleado'] = &$this->empleado;

		// fecha
		$this->fecha = new cField('pedido', 'pedido', 'x_fecha', 'fecha', '`fecha`', 'DATE_FORMAT(`fecha`, \'%d/%m/%Y\')', 133, 7, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
