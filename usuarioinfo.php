...
class cusuario extends cTable {
	...
	function __construct() {
		...
		// ci
		$this->ci = new cField('usuario', 'usuario', 'x_ci', 'ci', '`ci`', '`ci`', 3, -1, FALSE, '`ci`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ci->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ci'] = &$this->ci;

		// empresa
		$this->empresa = new cField('usuario', 'usuario', 'x_empresa', 'empresa', '`empresa`', '`empresa`', 3, -1, FALSE, '`empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
