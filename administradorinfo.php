...
//
// Table class for administrador
//
class cadministrador extends cTable {
	var $id;
	var $ci;
	var $nombre;
	var $cargo;
	...
	function __construct() {
		...
		$this->TableVar = 'administrador';
		$this->TableName = 'administrador';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`administrador`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('administrador', 'administrador', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// ci
		$this->ci = new cField('administrador', 'administrador', 'x_ci', 'ci', '`ci`', '`ci`', 3, -1, FALSE, '`ci`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ci->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ci'] = &$this->ci;

		// nombre
		$this->nombre = new cField('administrador', 'administrador', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['nombre'] = &$this->nombre;

		// cargo
		$this->cargo = new cField('administrador', 'administrador', 'x_cargo', 'cargo', '`cargo`', '`cargo`', 200, -1, FALSE, '`cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['cargo'] = &$this->cargo;

		// empresa
		$this->empresa = new cField('administrador', 'administrador', 'x_empresa', 'empresa', '`empresa`', '`empresa`', 3, -1, FALSE, '`empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`administrador`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("administradorview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("administradorview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "administradoradd.php?" . $this->UrlParm($parm);
		else
			$url = "administradoradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("administradoredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("administradoradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("administradordelete.php", $this->UrlParm());
	}
