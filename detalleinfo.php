...
//
// Table class for detalle
//
class cdetalle extends cTable {
	var $id;
	var $pedido;
	var $libro;
	var $empresa;
	...
	function __construct() {
		...
		$this->TableVar = 'detalle';
		$this->TableName = 'detalle';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`detalle`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('detalle', 'detalle', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// pedido
		$this->pedido = new cField('detalle', 'detalle', 'x_pedido', 'pedido', '`pedido`', '`pedido`', 3, -1, FALSE, '`pedido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pedido->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`detalle`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("detalleview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("detalleview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "detalleadd.php?" . $this->UrlParm($parm);
		else
			$url = "detalleadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("detalleedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("detalleadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("detalledelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->pedido->EditValue = $this->pedido->CurrentValue;
