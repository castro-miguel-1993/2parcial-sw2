...
<?php if ($usuario->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_usuario_id" class="col-sm-2 control-label ewLabel"><?php echo $usuario->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $usuario->id->CellAttributes() ?>>
<span id="el_usuario_id">
<span<?php echo $usuario->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $usuario->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="usuario" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($usuario->id->CurrentValue) ?>">
...
<input type="text" data-table="usuario" data-field="x_nombre" name="x_nombre" id="x_nombre" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($usuario->nombre->getPlaceHolder()) ?>" value="<?php echo $usuario->nombre->EditValue ?>"<?php echo $usuario->nombre->EditAttributes() ?>>
</span>
...
<?php if ($usuario->ci->Visible) { // ci ?>
	<div id="r_ci" class="form-group">
		<label id="elh_usuario_ci" for="x_ci" class="col-sm-2 control-label ewLabel"><?php echo $usuario->ci->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
