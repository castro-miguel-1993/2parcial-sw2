...
class cdetalle_list extends cdetalle {
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->pedido); // pedido
			$this->UpdateSort($this->libro); // libro
...
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle->SortUrl($detalle->id) ?>',1);">
...
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle->SortUrl($detalle->pedido) ?>',1);">
...
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle->SortUrl($detalle->libro) ?>',1);">
...
<?php echo $detalle->libro->ListViewValue() ?></span>
	...
	<?php if ($detalle->empresa->Visible) { // empresa ?>
		<?php if ($detalle->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="detalle_empresa">
<?php if ($detalle->Export <> "" || $detalle->SortUrl($detalle->empresa) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $detalle->empresa->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle->SortUrl($detalle->empresa) ?>',1);">
            	<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $detalle->empresa->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($detalle->empresa->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($detalle->empresa->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
				</div>
<?php } ?>
			</span></td>
			<td<?php echo $detalle->empresa->CellAttributes() ?>>
<span id="el<?php echo $detalle_list->RowCnt ?>_detalle_empresa">
...
<?php echo $detalle->empresa->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group detalle_empresa">
			<label class="col-sm-2 control-label ewLabel"><?php echo $detalle->empresa->FldCaption() ?></label>
...
<option value="ALL"<?php if ($detalle->getRecordsPerPage() == -1) { ?> selected<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
