...
$detalle_view = NULL; // Initialize page object first

class cdetalle_view extends cdetalle {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "detallelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "detallelist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "detallelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($detalle_view)) $detalle_view = new cdetalle_view();

// Page init
$detalle_view->Page_Init();

// Page main
$detalle_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$detalle_view->Page_Render();
?>
...
var CurrentForm = fdetalleview = new ew_Form("fdetalleview", "view");

// Form_CustomValidate event
fdetalleview.Form_CustomValidate = 
...
fdetalleview.ValidateRequired = true;
<?php } else { ?>
fdetalleview.ValidateRequired = false; 
<?php } ?>
...
<?php $detalle_view->ExportOptions->Render("body") ?>
<?php
	foreach ($detalle_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $detalle_view->ShowPageHeader(); ?>
<?php
$detalle_view->ShowMessage();
?>
<form name="fdetalleview" id="fdetalleview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($detalle_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $detalle_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="detalle">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($detalle->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_detalle_id"><?php echo $detalle->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $detalle->id->CellAttributes() ?>>
<span id="el_detalle_id">
<span<?php echo $detalle->id->ViewAttributes() ?>>
<?php echo $detalle->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle->pedido->Visible) { // pedido ?>
	<tr id="r_pedido">
		<td><span id="elh_detalle_pedido"><?php echo $detalle->pedido->FldCaption() ?></span></td>
		<td data-name="pedido"<?php echo $detalle->pedido->CellAttributes() ?>>
<span id="el_detalle_pedido">
<span<?php echo $detalle->pedido->ViewAttributes() ?>>
<?php echo $detalle->pedido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle->libro->Visible) { // libro ?>
	<tr id="r_libro">
		<td><span id="elh_detalle_libro"><?php echo $detalle->libro->FldCaption() ?></span></td>
		<td data-name="libro"<?php echo $detalle->libro->CellAttributes() ?>>
