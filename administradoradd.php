...
$administrador_add = NULL; // Initialize page object first

class cadministrador_add extends cadministrador {
	...
	// Page object name
	var $PageObjName = 'administrador_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "administradorview.php")
...
// Create page object
if (!isset($administrador_add)) $administrador_add = new cadministrador_add();

// Page init
$administrador_add->Page_Init();

// Page main
$administrador_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$administrador_add->Page_Render();
?>
...
var CurrentForm = fadministradoradd = new ew_Form("fadministradoradd", "add");

// Validate form
fadministradoradd.Validate = function() {
...
fadministradoradd.Form_CustomValidate = 
...
fadministradoradd.ValidateRequired = true;
<?php } else { ?>
fadministradoradd.ValidateRequired = false; 
<?php } ?>
...
<?php $administrador_add->ShowPageHeader(); ?>
<?php
$administrador_add->ShowMessage();
?>
<form name="fadministradoradd" id="fadministradoradd" class="<?php echo $administrador_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($administrador_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $administrador_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $administrador_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fadministradoradd.Init();
</script>
<?php
$administrador_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$administrador_add->Page_Terminate();
?>
